    ...
    <>
      ...
      <section className="hero">
        <div className="hero-content">
          <p className="hero-tagline">WELCOME TO AL-MADINAH TRAVELS & TOURS</p>
          <h1>
        ...
        <div className="why-wrapper">
          <div className="why-text">
            ...
            <p className="why-desc">
              At Al-Madinah Travels & Tours, Umrah is more than travel — it is a
