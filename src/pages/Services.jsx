...
const Services = () => {
  ...
  const makkahHotels = [
    ...
    { id: 1, name: "Fairmont Makkah Clock Royal Tower", type: "luxury", slug: "fairmont-makkah", period: "Flexible", distance: "0m", sharing: "800", double: "900", triple: "850", quad: "800", quint: "750", meals: "Breakfast Included", rating: 5, location: "Makkah", priceFrom: "900", amenities: ["Free WiFi", "Haram View", "Luxury Dining"], image: "/assets/images/fairmount-hotel.webp" },
    ...
    { id: 3, name: "Hyatt Regency Makkah", type: "luxury", slug: "hyatt-makkah", period: "Flexible", distance: "150m", sharing: "680", double: "750", triple: "710", quad: "670", quint: "630", meals: "Half Board", rating: 5, location: "Makkah", priceFrom: "750", amenities: ["Gym", "Free WiFi", "Near Haram"], image: "/assets/images/hyatt-hotel.webp" },
    { id: 4, name: "Hilton Convention Makkah", type: "luxury", slug: "hilton-convention", period: "Flexible", distance: "300m", sharing: "600", double: "680", triple: "640", quad: "600", quint: "560", meals: "Breakfast Included", rating: 5, location: "Makkah", priceFrom: "680", amenities: ["Free WiFi", "Parking", "Restaurant"], image: "/assets/images/hilton-makkah.webp" },
    { id: 5, name: "Raffles Makkah Palace", type: "luxury", slug: "raffles-makkah", period: "Flexible", distance: "50m", sharing: "950", double: "1050", triple: "1000", quad: "950", quint: "900", meals: "Full Board", rating: 5, location: "Makkah", priceFrom: "1050", amenities: ["Spa", "Butler Service", "VIP Lounge"], image: "/assets/images/raffles-hotel.webp" },
  ...
  const madinahHotels = [
    ...
    { id: 14, name: "Pullman Zamzam Madina", type: "luxury", slug: "pullman-madinah", period: "Flexible", distance: "150m", sharing: "600", double: "680", triple: "640", quad: "600", quint: "560", meals: "Half Board", rating: 5, location: "Madinah", priceFrom: "680", amenities: ["Free WiFi", "City View", "Restaurant"], image: "/assets/images/pullman-hotel.webp" },
    ...
    { id: 16, name: "Shaza Al Madina", type: "luxury", slug: "shaza-madinah", period: "Flexible", distance: "150m", sharing: "600", double: "680", triple: "640", quad: "600", quint: "560", meals: "Room Only", rating: 5, location: "Madinah", priceFrom: "680", amenities: ["Boutique Style", "Fine Dining", "Free WiFi"], image: "/assets/images/sheza-hotel.webp" },
    { id: 17, name: "Dar Al Taqwa Hotel", type: "luxury", slug: "dar-al-taqwa", period: "Flexible", distance: "20m", sharing: "700", double: "780", triple: "740", quad: "700", quint: "660", meals: "Full Board", rating: 5, location: "Madinah", priceFrom: "780", amenities: ["Luxury Decor", "Front Row", "VIP Service"], image: "/assets/images/dar-al-taqwa-hotel.webp" },
    ...
    { id: 24, name: "Al Manakha Rotana Madinah", type: "luxury", slug: "al-manakha-rotana-madinah", period: "Flexible", distance: "350m", sharing: "540", double: "620", triple: "580", quad: "540", quint: "500", meals: "Breakfast Included", rating: 4, location: "Madinah", priceFrom: "620", amenities: ["Free WiFi", "Restaurant"], image: "/assets/images/almanakhahotel.webp" },
    ...
    { id: 29, name: "View Al Madinah Hotel", type: "luxury", slug: "view-al-madinah-hotel", period: "Flexible", distance: "250m", sharing: "520", double: "600", triple: "560", quad: "520", quint: "480", meals: "Room Only", rating: 4, location: "Madinah", priceFrom: "600", amenities: ["Free WiFi", "Modern Rooms"], image: "/assets/images/viewalmadinahhotel.webp" },
    { id: 30, name: "Makarem Haram View Suites", type: "luxury", slug: "makarem-haram-view-suites", period: "Flexible", distance: "80m", sharing: "750", double: "830", triple: "790", quad: "750", quint: "710", meals: "Breakfast Included", rating: 5, location: "Madinah", priceFrom: "830", amenities: ["Haram View", "Luxury Suites"], image: "/assets/images/makaremharamsuites.webp" },
    ...
    <table className="hotel-table">
      <thead>
        <tr>
          ...
          <th>Location</th>
          {category === "economy" && <th>Sharing</th>}
          <th>Double</th>
          <th>Triple</th>
          <th>Quad</th>
          <th>Quint</th>
      ...
      <tbody>
        {hotels.map(hotel => (
          <tr key={hotel.id}>
            ...
            <td>{category === "luxury" ? hotel.location : hotel.locationNote || "—"}</td>
            {category === "economy" && (
              <td>{hotel.sharing ? hotel.sharing + " SAR" : "—"}</td>
            )}
