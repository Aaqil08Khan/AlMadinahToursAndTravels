      ...
      <div style={styles.ratesCard}>
        <div style={styles.header}>
          <div style={styles.headerTop}>
            ...
            <div style={{ textAlign: "right" }}>
              <div
                ...
                className="social-section-responsive"
              >
                <div
                  style={styles.socialIcons}
                  className="social-icons-responsive"
                >
                  <a
                    href="#"
                    style={{
                ...
                <div
                  ...
                  className="social-handle-responsive"
                >
                  @almadinatraveltour
                </div>
              </div>
          ...
          <div style={styles.titleSection}>
            <div style={styles.visaText}>
              Visa Only (Without Transport <b>530 SAR</b>)
            </div>
        ...
        <div>
          {vehicles.map((vehicle, idx) => (
            <div
              key={idx}
              style={{ border: "2px solid #0d3b66", marginBottom: "10px" }}
            >
              {/* HEADER ROW */}
              <div
                style={{
        ...
        <div style={styles.footer}>
          <div style={styles.contactItem}>
            <FaPhone /> +966 51 013 9093
          </div>
          <div style={styles.contactItem}>
            <FaEnvelope /> info@almadinatraveltour.com
          </div>
        </div>
      </div>
    </div>
